---
title: 'Covid-19/Corona Virus: Quick look at some data'
author: Roland
date: '2020-03-12'
...
COVID-19, or better known as the Corona virus, has arrived in earnest in Austria. Experts saw it coming for a while, and Austria's government eventually geared up and introduced rather comprehensive measures to tackle the virus' spread. All in all, enough reasons to have a quick look at some of the available data. To be clear, there are already a number of very comprehensive data analysis available, and I am not pretending to catch up with those. My primary intention is first and foremost to have a look at the situation in Austria (with R).

I'll be very brief due to lack of time (kids are at home, partner on home office duty...), but I guess most of the graphs are selfexplantory. If you think  there is a glarring error etc., don't hestiate and let me know (best via Twitter DM at [@zoowalk](https://twitter.com/zoowalk){target="_blank"})
...
The data for this analysis is taken from Johns Hopkins COVID-19 data repository, which seems to be one of, if not the most frequenlty used data source on Covid-19. Have a look at their [site](https://coronavirus.jhu.edu/){target="_blank"} for more details.
...
Critically, one may ajust the number of confirmed cases with the population size of the coutnry. The graph below presents the modified result.
...
What if we look at the increase in realtive terms, as growth rates:
