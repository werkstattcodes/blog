...
pl_test_results_interval <- df_p1 %>%   
  ...
  labs(title="Covid-19/Austria: Test results per publication period",
       ...
       # ": Number of confirmed infections since preceding publication of results. Data as of {format(latest_time, '%A, %d %b %Y - %H:%M hrs')}. "), 
       #                   120),
       subtitle=glue("<span style='color:orange'>Total number</span> of tests since preceding publication of results.", "<br><span style='color:red'>Number of confirmed infections</span>:","since preceding publication of results. <br>Data as of {format(latest_time, '%A, %d %b %Y - %H:%M hrs')}. "),
       caption=my_caption)+
