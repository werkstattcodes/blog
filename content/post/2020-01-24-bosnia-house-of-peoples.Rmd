...
```
*Site might be best viewed on a computer, rather than mobile device.*
...
plot_quorum_number <- df_quorum %>% 
  ...
  labs(title="Presence of HoP: Number of delegates per decision and constituent people",
       subtitle=str_wrap("Legilsative period 2014-2018. In no instance less than three delegates per constitutent people were present. Hence quorum requirements were always fullfiled.", 160),
...
plot_cube <- plot_ly(df_HoP_share_grouped, 
  ...
  add_markers() %>%
  layout(scene = list(xaxis = list(title = 'yes share Bosniak'),
